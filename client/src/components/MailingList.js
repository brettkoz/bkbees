...
export default class MailingList extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <form action="https://bkbees.us11.list-manage.com/subscribe/post"l className="form-inline" method="POST">
    ...
    <input type="hidden" name="ht" value="6dd5595f603f3525e97ddb0e177250ce6341471c:MTU0Mjg1NTA1Mi42Mzg4"/>
