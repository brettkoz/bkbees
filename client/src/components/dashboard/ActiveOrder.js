    ...
    if (this.props.order == null) {
      ...
      orderContent = (
        <div className="order-display">
          ...
          <button className="btn btn-primary" onClick={() => this.showModify()}>
            Modify Order
          </button>
        </div>
      );
        ...
        <form className=" modifyOrderForm">
          <div className="form-group">
            ...
            <input
              ...
              id="name"
              placeholder={this.props.order.name}
            />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
              id="date"
              placeholder={this.props.order.date}
            />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
              id="emailInput"
              placeholder={this.props.order.email}
            />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
              id="phone"
              placeholder={this.props.order.phone}
            />
          </div>
          <div className="form-group">
