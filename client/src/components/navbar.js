    ...
    <nav className="navbar navbar-expand-lg navbar-light static-top">
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarResponsive">
          ...
          data-target="#navbarResponsive" to="/bees">
                Bees
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" data-toggle="collapse"
          data-target="#navbarResponsive" to="/learn">
                Learn
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" data-toggle="collapse"
          data-target="#navbarResponsive" to="/about">
                About
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" data-toggle="collapse"
          data-target="#navbarResponsive" to="/contact">
                Contact
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" data-toggle="collapse"
          data-target="#navbarResponsive" to="/register">
                Register
              </Link>
            </li>
            <li className="nav-item">
